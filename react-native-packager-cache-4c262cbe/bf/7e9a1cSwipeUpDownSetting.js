...
SwipeUpDownSetting=function(_Component){babelHelpers.inherits(SwipeUpDownSetting,_Component);
function SwipeUpDownSetting(props){babelHelpers.classCallCheck(this,SwipeUpDownSetting);var _this=babelHelpers.possibleConstructorReturn(this,(SwipeUpDownSetting.__proto__||Object.getPrototypeOf(SwipeUpDownSetting)).call(this,
props));
...
{name:'9',image:'http://104.131.83.218/makeoffer/upload/categoryimage/10.png'}];return _this;

}babelHelpers.createClass(SwipeUpDownSetting,[{key:'onShopButtonClk',value:function onShopButtonClk(
...
}}]);return SwipeUpDownSetting;}(_react.Component);exports.default=SwipeUpDownSetting;
